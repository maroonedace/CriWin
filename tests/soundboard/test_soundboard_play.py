...
from src.commands.soundboard.play import _build_source, handle_play
...
class TestSoundboard:
    ...
    async def test_invalid_voice_state(self, mock_invalid_interaction):
        ...
        with patch(
            "src.commands.soundboard.play.send_message", new_callable=AsyncMock
            ...
            mock_send_message.assert_called_once_with(
                mock_invalid_interaction, VOICE_STATE_INVALID_MESSAGE
            )
    ...
    async def test_unavailable_sounds(self, mock_valid_interaction):
        ...
        with patch("src.commands.soundboard.play.get_sounds") as mock_sounds:
            ...
            with patch(
                ...
                # Assert that send_message was called with correct arguments
                mock_send_message.assert_called_once_with(mock_valid_interaction, "Invalid")
    ...
    async def test_unavailable_sound(self, mock_valid_interaction):
        ...
        with patch("src.commands.soundboard.play.get_sounds") as mock_sounds:
            ...
            with patch(
                ...
                # Assert that send_message was called with correct arguments
                mock_send_message.assert_called_once_with(
                    mock_valid_interaction, UNAVAILABLE_SOUND_MESSAGE
                )
...
class TestBuildSource:
    def test_applies_stored_volume(self):
        with (
            patch("src.commands.soundboard.play.FFmpegPCMAudio") as ffmpeg,
